...
extern "C" {
    ...
    fn __gmpz_legendre(n: mpz_srcptr, d: mpz_srcptr) -> c_int;
    ...
    fn __gmpz_probab_prime_p(rop: mpz_srcptr, op: c_int) -> c_int;
...
impl Mpz {
    ...
    pub fn probab_prime_p(&self, reps: i32) -> bool {
        unsafe {
            __gmpz_probab_prime_p(&self.mpz, reps as c_int) != 0
        }
    }
    ...
    pub fn legendre(&self, other: &Mpz) -> i8 {
        unsafe {
            __gmpz_legendre(&self.mpz, &other.mpz) as i8
        }
    }
